...
import com.example.miniprojectfoodwarehousemanagement.databinding.ActivityDairy2Binding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class Dairy : AppCompatActivity() {
    private lateinit var binding: ActivityDairy2Binding
    private lateinit var database: DatabaseReference
    private lateinit var stocks: Button
    private lateinit var scan: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDairy2Binding.inflate(layoutInflater )
